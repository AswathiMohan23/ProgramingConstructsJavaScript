...
const inputFromConsole = process.argv; // Create a constant inputFromConsole and set it to process.argv properties: 
...
//which we want it to execute in our case its fileName.js’, so we have to remove it by using slice method.
